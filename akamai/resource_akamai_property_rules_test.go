...
func TestAccAkamaiPropertyRules_basic(t *testing.T) {
	json := `{"accountId":"","contractId":"","groupId":"","propertyId":"","propertyVersion":0,"etag":"","ruleFormat":"","rules":{"name":"default","behaviors":[{"name":"origin","options":{"cacheKeyHostname":"ORIGIN_HOSTNAME","compress":1,"enableTrueClientIp":0,"forwardHostHeader":"REQUEST_HOST_HEADER","hostname":"example.org","httpPort":80,"httpsPort":443,"originCertificate":"","originSni":1,"originType":"CUSTOMER","ports":"","verificationMode":"PLATFORM_SETTINGS"}},{"name":"caching","options":{"behavior":"MAX_AGE","mustRevalidate":false,"ttl":"1d"}},{"name":"cpCode","options":{"id":"cp-code-id","name":"cp-code-name"}}],"options":{}}}`
