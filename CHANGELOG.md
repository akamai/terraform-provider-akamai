...
* [FIX] Criteria is always end up using must satisfy "all" (`akamai_property`) [GH-81]
* [FIX] Provider produced inconsistent final plan (`akamai_property_variables`) [GH-82]
* [FIX] Cannot create multiple types of records with the same name (`akamai_dns_record`) [GH-11]
* [FIX] akamai_property_activation resource - changing network field causes deactivation of version in staging (`akamai_property_activation`) [GH-51]
* [FIX] Multiple MX records creation issue (`akamai_dns_record`) [GH-57]
