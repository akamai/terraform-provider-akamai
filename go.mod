...
replace (
	...
	go.opentelemetry.io/otel/sdk/metric v1.43.0 => go.opentelemetry.io/otel/sdk/metric v1.44.0 // Fix security vulnerability; can be removed once github.com/hashicorp/terraform-plugin-go bumps this dependency
)
