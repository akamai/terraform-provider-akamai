...
output "secpolicyclone" {
  value = akamai_appsec_security_policy_clone.appsecsecuritypolicyclone.security_policy_id
}
...
data "akamai_appsec_waf_mode" "appsecwafmodes" {
    config_id = data.akamai_appsec_configuration.appsecconfigedge.config_id
    version = data.akamai_appsec_configuration.appsecconfigedge.latest_version
    security_policy_id = "AAAA_81230"
}
...
output "appsecwafmodes" {
  value = data.akamai_appsec_waf_mode.appsecwafmodes.output_text
}
...
data "akamai_appsec_penalty_box" "appsecpenaltybox" {
    config_id = data.akamai_appsec_configuration.appsecconfigedge.config_id
    version = data.akamai_appsec_configuration.appsecconfigedge.latest_version
    security_policy_id = "AAAA_81230"
}
...
output "appsecpenaltyboxes" {
  value = data.akamai_appsec_penalty_box.appsecpenaltybox.output_text
}
