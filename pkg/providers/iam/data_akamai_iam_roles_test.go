...
func TestDataRoles(t *testing.T) {
	...
	t.Run("happy path/no args", func(t *testing.T) {
		...
		client.IAM.On("ListRoles", testutils.MockContext, req).Return(roles, nil)
	...
	t.Run("fail path", func(t *testing.T) {
		...
		client := edgegrid.NewTestClient()
		client.IAM.Test(testutils.TattleT{T: t})
		client.IAM.On("ListRoles", testutils.MockContext, req).Return(nil, errors.New("failed to get roles"))
