...
func TestAkamaiApiHostnameCoverageMatchTargets_data_basic(t *testing.T) {
	...
	t.Run("match by ApiHostnameCoverageMatchTargets ID", func(t *testing.T) {
		...
		err := json.Unmarshal(testutils.LoadFixtureBytes(t, "testdata/TestDSApiHostnameCoverageMatchTargets/ApiHostnameCoverageMatchTargets.json"), &getMatchTargetsResponse)
		...
		client.APPSEC.On("GetApiHostnameCoverageMatchTargets",
			testutils.MockContext,
		...
		resource.UnitTest(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: testutils.LoadFixtureString(t, "testdata/TestDSApiHostnameCoverageMatchTargets/match_by_id.tf"),
