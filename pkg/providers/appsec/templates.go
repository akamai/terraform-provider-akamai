...
func InitTemplates(otm map[string]*OutputTemplate) {
	...
	otm["penaltyBoxesDS"] = &OutputTemplate{TemplateName: "penaltyBoxesDS", TableTitle: "PenaltyBoxProtection|Action", TemplateType: "TABULAR", TemplateString: "{{.PenaltyBoxProtection}}|{{.Action}}"}
	...
	otm["KRSRulesDS"] = &OutputTemplate{TemplateName: "KRSRulesDS", TableTitle: "ID|Action", TemplateType: "TABULAR", TemplateString: "{{range $index, $element := .RuleActions}}{{if $index}},{{end}}{{.ID}}|{{.Action}}{{end}}"}
	...
	otm["WAFAttackGroupActionDS"] = &OutputTemplate{TemplateName: "WAFAttackGroupAction", TableTitle: "GroupID|Action", TemplateType: "TABULAR", TemplateString: "{{range $index, $element := .AttackGroupActions}}{{if $index}},{{end}}{{.Group}}| {{.Action}}{{end}}"}
