...
func TestAccAkamaiSelectedHostname_res_basic(t *testing.T) {
	t.Run("match by SelectedHostname ID", func(t *testing.T) {
		...
		client.On("UpdateSelectedHostname",
			mock.Anything, // ctx is irrelevant for this test
			//appsec.UpdateSelectedHostnameRequest{ConfigID: 43253, Version: 7, HostnameList: []appsec.Hostname(nil)},
				...
				Steps: []resource.TestStep{
					{
						...
						Check: resource.ComposeAggregateTestCheckFunc(
							resource.TestCheckResourceAttr("akamai_appsec_selected_hostnames.test", "id", "43253:7"),
						),
