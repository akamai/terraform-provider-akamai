		...
		Versions: []mtlskeystore.ClientCertificateVersion{
			{
				...
				KeyAlgorithm:       "RSA",
				EllipticCurve:      ptr.To("test-rsa"),
				KeySizeInBytes:     ptr.To("2048"),
				SignatureAlgorithm: ptr.To("SHA256_WITH_RSA"),
				Status:             "DEPLOYED",
				Subject:            ptr.To("/C=US/O=Akamai Technologies/OU=test/CN=test/"),
			...
			},
			{
				...
				Issuer:              ptr.To("test-issuer"),
				KeyAlgorithm:        "ECDSA",
				EllipticCurve:       ptr.To("test-ecdsa"),
				ScheduledDeleteDate: ptr.To(tst.NewTimeFromString(t, "2024-05-20T23:08:07Z")),
				SignatureAlgorithm:  ptr.To("SHA256_WITH_RSA"),
