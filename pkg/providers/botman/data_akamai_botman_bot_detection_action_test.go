		...
		useClient(mockedBotmanClient, func() {
			...
			resource.Test(t, resource.TestCase{
				...
				Steps: []resource.TestStep{
					{
						Config: testutils.LoadFixtureString(t, "testdata/TestDataBotDetectionAction/basic.tf"),
	...
	"actions":[
		...
		useClient(mockedBotmanClient, func() {
			...
			resource.Test(t, resource.TestCase{
				...
				Steps: []resource.TestStep{
					{
						Config: testutils.LoadFixtureString(t, "testdata/TestDataBotDetectionAction/filter_by_id.tf"),
						Check: resource.ComposeAggregateTestCheckFunc(
							resource.TestCheckResourceAttr("data.akamai_botman_bot_detection_action.test", "json", compactJSON(expectedJSON))),
					},
				},
