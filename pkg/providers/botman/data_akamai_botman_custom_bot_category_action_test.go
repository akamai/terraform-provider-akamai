		...
		expectedJSON := `
{
	"actions":[
		...
		client.BotMan.On("GetCustomBotCategoryActionList",
		...
		resource.UnitTest(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: testutils.LoadFixtureString(t, "testdata/TestDataCustomBotCategoryAction/basic.tf"),
		...
		expectedJSON := `
{
	"actions":[
		...
		resource.UnitTest(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: testutils.LoadFixtureString(t, "testdata/TestDataCustomBotCategoryAction/filter_by_id.tf"),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.akamai_botman_custom_bot_category_action.test", "json", compactJSON(expectedJSON))),
				},
			},
