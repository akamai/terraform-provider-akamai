		...
		expectedJSON := `
{
	"conditionalActions":[
		...
		client.BotMan.On("GetConditionalActionList",
		...
		resource.UnitTest(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: testutils.LoadFixtureString(t, "testdata/TestDataConditionalAction/basic.tf"),
		...
		expectedJSON := `
{
	"conditionalActions":[
		...
		resource.UnitTest(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: testutils.LoadFixtureString(t, "testdata/TestDataConditionalAction/filter_by_id.tf"),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.akamai_botman_conditional_action.test", "json", compactJSON(expectedJSON))),
				},
			},
