...
func TestResourceConditionalAction(t *testing.T) {
	...
	t.Run("ResourceConditionalAction", func(t *testing.T) {
		...
		client.BotMan.On("CreateConditionalAction",
		...
		client.BotMan.On("GetConditionalAction",
			testutils.MockContext,
		...
		client.BotMan.On("UpdateConditionalAction",
			testutils.MockContext,
		...
		client.BotMan.On("RemoveConditionalAction",
			testutils.MockContext,
