			...
			resource.UnitTest(t, resource.TestCase{
				...
				Steps: []resource.TestStep{{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						testCheckResourceAttrJSONFromFixture("data.akamai_property_rules_builder.default", "json",
							"testdata/TestDSPropertyRulesBuilder/default.json"),

						resource.TestCheckResourceAttr("data.akamai_property_rules_builder.content_compression", "rule_format", "v2023-01-05"),
						testCheckResourceAttrJSONFromFixture("data.akamai_property_rules_builder.content_compression", "json",
							"testdata/TestDSPropertyRulesBuilder/content_compression.json"),

						resource.TestCheckResourceAttr("data.akamai_property_rules_builder.static_content", "rule_format", "v2023-01-05"),
						testCheckResourceAttrJSONFromFixture("data.akamai_property_rules_builder.static_content", "json",
							"testdata/TestDSPropertyRulesBuilder/static_content.json"),

						resource.TestCheckResourceAttr("data.akamai_property_rules_builder.dynamic_content", "rule_format", "v2023-01-05"),
						testCheckResourceAttrJSONFromFixture("data.akamai_property_rules_builder.dynamic_content", "json",
							"testdata/TestDSPropertyRulesBuilder/dynamic_content.json"),
					),
				}},
			})
		})
