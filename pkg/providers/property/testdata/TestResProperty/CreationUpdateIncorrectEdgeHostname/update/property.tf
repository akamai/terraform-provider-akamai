...
data "akamai_property_rules_template" "akarules" {
  template_file = "testdata/TestResProperty/CreationUpdateIncorrectEdgeHostname/update/property-snippets/rules.json"
}
...
resource "akamai_property" "test" {
  ...
  hostnames {
    cname_to               = "does-not-exist.com.example.net"
    cname_from             = "does-not-exist.com"
    cert_provisioning_type = "CPS_MANAGED"
  }
