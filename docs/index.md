...
|[DataStream](https://techdocs.akamai.com/terraform/docs/v3.5/set-up-datastream)|Monitor activity on the ​Akamai​ platform and send live log data to a destination of your choice.|
