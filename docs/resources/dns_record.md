...
The following fields are optional depending on configuration type. See [DNS Getting Started Guide](get_started_dns_zone.html#working-with-mx-records) for more information.
