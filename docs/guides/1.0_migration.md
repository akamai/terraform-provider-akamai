...
* IPV4 and IPV6 fields deprecated in favor of directly setting ip_behavior to desired value see [`akamai_edge_hostname` datasource documentation](../data-sources/property_rules_template.md).  
### Field Renaming
* Rename the following fields contract->contract_id, group->group_id, product->product_id.  
### Create and Import Changes
