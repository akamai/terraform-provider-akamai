...
The `akamai_cp_code` resource no longer supports these fields:
...
The `akamai_edge_hostname` resource no longer supports these fields:
...
These fields were removed as they were not being used:
