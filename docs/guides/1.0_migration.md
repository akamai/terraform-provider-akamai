...
See the [cpCode behavior](https://techdocs.akamai.com/property-mgr/reference/latest-cpcode) for additional information. 
...
See additional documentation on [property rule trees](https://techdocs.akamai.com/property-mgr/reference/rule-trees)
...
```
See [Property origin](https://techdocs.akamai.com/property-mgr/reference/latest-origin) for more details.

## Migrate akamai_property variables

The Property Provisioning module used to have the `akamai_property_variables` resource that 
...
See documentation on [declaring property variables](https://techdocs.akamai.com/property-mgr/reference/declare-a-variable) for more information.
